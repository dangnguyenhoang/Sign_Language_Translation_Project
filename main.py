...
model = tf.keras.models.load_model("models/Sign_language_20ep.h5")
class_names = np.array(['L', '9', 'Y', 'T', 'DEL', 'F', '7', 'Q', 'E', 'A', 'X', '8', '4', 'I', 'W', 'O', 'P', 'C', 'G', 'SPACE', 'B', '3', 'U', 'N', 'K', '5', '6', 'R', 'D', '2', 'S', '0', 'H', 'J', 'V', '1', 'M', 'Z'])
